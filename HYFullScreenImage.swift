//
//  HYFullScreenImage.swift
//  FLEETS
//
//  Created by Hadi on 10/9/18.
...
final class HYFullScreenImage: UIViewController, UIScrollViewDelegate {
    
    //Properties
    var retainHolder: HYFullScreenImage!
    let image : UIImage
    ...
    @objc func panGestureCallback(_ sender: UIPanGestureRecognizer) {
        ...
        case .ended:
            ...
            if totalDistance > 12600 {
                ...
                //Animate the frame to be as the original circle
